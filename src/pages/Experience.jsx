  ...
  return (
    <PageShell title={null} searchText={searchText} scrollSnap>
      <section className="mx-auto w-full max-w-5xl px-4 sm:px-6">
        {/* Section: Pencapaian */}
        <section id="pencapaian" className="w-full max-w-5xl scroll-mt-28 lg:snap-start pt-4 pb-10 sm:pt-6 sm:pb-12">
        ...
        <section id="prestasi-akademik" className="w-full max-w-5xl scroll-mt-28 lg:snap-start pt-10 pb-10 sm:pt-12 sm:pb-12">
          <div className="flex justify-center">
            <div className="inline-flex rounded-[2rem] bg-[#7a324c] px-8 py-3 shadow-[0_18px_35px_rgba(0,0,0,0.35)]">
              <h2
                className="select-none text-center text-[clamp(3rem,7vw,4.5rem)] text-pink-50 animate-fade-in-up"
        ...
        <section id="karya-pribadi" className="w-full max-w-5xl scroll-mt-28 lg:snap-start pt-10 pb-10 sm:pt-12 sm:pb-12">
          <div className="flex justify-center">
            <div className="inline-flex rounded-[2rem] bg-[#7a324c] px-8 py-3 shadow-[0_18px_35px_rgba(0,0,0,0.35)]">
              <h2
                className="select-none text-center text-[clamp(3rem,7vw,4.5rem)] text-pink-50 animate-fade-in-up"
        ...
        {/* Section: Organisasi */}
        <section id="organisasi" className="w-full max-w-5xl scroll-mt-28 lg:snap-start pt-10 pb-10 sm:pt-12 sm:pb-12">
          <div className="flex justify-center">
            <div className="inline-flex rounded-[2rem] bg-[#7a324c] px-8 py-3 shadow-[0_18px_35px_rgba(0,0,0,0.35)]">
              <h2
                className="select-none text-center text-[clamp(3rem,7vw,4.5rem)] text-pink-50 animate-fade-in-up"
        ...
        {/* Section: Sertifikasi */}
        <section id="sertifikasi" className="w-full max-w-5xl scroll-mt-28 lg:snap-start pt-10 pb-10 sm:pt-12 sm:pb-12">
          <div className="flex justify-center">
            <div className="inline-flex rounded-[2rem] bg-[#7a324c] px-8 py-3 shadow-[0_18px_35px_rgba(0,0,0,0.35)]">
              <h2
                className="select-none text-center text-[clamp(3rem,7vw,4.5rem)] text-pink-50 animate-fade-in-up"
